...
test("resolve import", async () => {
  expect(
    await resolveImport("@/foo/bar", {
      absoluteBaseUrl: "/Users/luxdefi/Projects/foobar",
      paths: {
        "@/*": ["./src/*"],
  ...
  ).toEqual("/Users/luxdefi/Projects/foobar/src/foo/bar")
  ...
  ).toEqual("/Users/luxdefi/Projects/foobar/src/components/foo/bar/baz")
  ...
  ).toEqual("/Users/luxdefi/Projects/foobar/src/app/components/foo/bar")
  ...
  ).toEqual("/Users/luxdefi/Projects/foobar/lib/utils")
})
